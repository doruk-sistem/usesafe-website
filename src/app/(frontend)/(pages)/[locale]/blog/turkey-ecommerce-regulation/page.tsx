...
export default function TurkeyEcommerceRegulationPage() {
  const { locale } = useParams();
    ...
    <div className="tw-bg-gray-50">
      ...
      {/* Content Section */}
      <div className="tw-max-w-5xl tw-mx-auto tw-px-6 tw-py-16">
        <div className="tw-bg-white tw-rounded-2xl tw-shadow-lg tw-p-12 tw-mb-8">
          <div className="tw-prose tw-max-w-none">
            <div className="tw-relative tw-mb-8">
              <div className="tw-absolute tw-inset-0 tw-bg-gradient-to-r tw-from-blue-500/10 tw-to-purple-500/10 tw-rounded-xl tw-blur-lg"></div>
              <Image src="/images/dpp-product.webp" alt="Turkey&apos;s New E-Commerce Product Safety Regulation" width={1000} height={1000} className="tw-rounded-xl tw-shadow-lg tw-w-full tw-h-auto tw-relative tw-z-10"/>
            </div>
            <div className="tw-bg-gradient-to-r tw-from-blue-50 tw-to-indigo-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <p className="tw-text-lg tw-text-gray-800 tw-leading-relaxed tw-mb-0">
            ...
            <div className="tw-text-center tw-mb-12">
              ...
              <div className="tw-w-24 tw-h-1 tw-bg-gradient-to-r tw-from-blue-500 tw-to-purple-500 tw-mx-auto tw-rounded-full"></div>
            </div>

            <div className="tw-bg-gradient-to-r tw-from-green-50 tw-to-emerald-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <div className="tw-inline-flex tw-items-center tw-px-3 tw-py-1 tw-bg-green-100 tw-text-green-800 tw-rounded-full tw-text-sm tw-font-medium tw-mb-4">
              ...
              <p className="tw-text-lg tw-text-gray-700 tw-leading-relaxed tw-mb-0">
            ...
            <div className="tw-bg-gradient-to-r tw-from-orange-50 tw-to-amber-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <div className="tw-inline-flex tw-items-center tw-px-3 tw-py-1 tw-bg-orange-100 tw-text-orange-800 tw-rounded-full tw-text-sm tw-font-medium tw-mb-4">
                <span className="tw-w-2 tw-h-2 tw-bg-orange-500 tw-rounded-full tw-mr-2"></span>
                Local Presence
              </div>
              <h3 className="tw-text-2xl tw-font-bold tw-text-gray-900 tw-mb-4">
            ...
            <div className="tw-bg-gradient-to-r tw-from-purple-50 tw-to-pink-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <div className="tw-inline-flex tw-items-center tw-px-3 tw-py-1 tw-bg-purple-100 tw-text-purple-800 tw-rounded-full tw-text-sm tw-font-medium tw-mb-4">
                <span className="tw-w-2 tw-h-2 tw-bg-purple-500 tw-rounded-full tw-mr-2"></span>
                Product Information
              </div>
              <h3 className="tw-text-2xl tw-font-bold tw-text-gray-900 tw-mb-4">
            ...
            <div className="tw-bg-gradient-to-r tw-from-cyan-50 tw-to-blue-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <div className="tw-inline-flex tw-items-center tw-px-3 tw-py-1 tw-bg-cyan-100 tw-text-cyan-800 tw-rounded-full tw-text-sm tw-font-medium tw-mb-4">
                <span className="tw-w-2 tw-h-2 tw-bg-cyan-500 tw-rounded-full tw-mr-2"></span>
            ...
            <div className="tw-bg-gradient-to-r tw-from-red-50 tw-to-orange-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <div className="tw-inline-flex tw-items-center tw-px-3 tw-py-1 tw-bg-red-100 tw-text-red-800 tw-rounded-full tw-text-sm tw-font-medium tw-mb-4">
                <span className="tw-w-2 tw-h-2 tw-bg-red-500 tw-rounded-full tw-mr-2"></span>
                Legal Consequences
              </div>
              <h3 className="tw-text-2xl tw-font-bold tw-text-gray-900 tw-mb-4">
            ...
            <div className="tw-text-center tw-mb-12">
              ...
              <div className="tw-w-24 tw-h-1 tw-bg-gradient-to-r tw-from-indigo-500 tw-to-purple-500 tw-mx-auto tw-rounded-full"></div>
            </div>
            <div className="tw-bg-gradient-to-r tw-from-indigo-50 tw-to-purple-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <p className="tw-text-lg tw-text-gray-800 tw-leading-relaxed tw-mb-0">
            ...
            <div className="tw-text-center tw-mb-12">
              <h2 className="tw-text-4xl tw-font-bold tw-text-gray-900 tw-mb-4">
                Steps for Manufacturers to Comply
              </h2>
              <div className="tw-w-24 tw-h-1 tw-bg-gradient-to-r tw-from-green-500 tw-to-teal-500 tw-mx-auto tw-rounded-full"></div>
            </div>
            <div className="tw-bg-gradient-to-r tw-from-green-50 tw-to-emerald-50 tw-rounded-xl tw-p-6 tw-mb-8">
              <p className="tw-text-lg tw-text-gray-800 tw-leading-relaxed tw-mb-0">
            ...
            <div className="tw-grid md:tw-grid-cols-2 lg:tw-grid-cols-3 tw-gap-6 tw-mb-8">
              {/* Step 1 */}
              <div className="tw-bg-gradient-to-br tw-from-green-50 tw-to-emerald-50 tw-rounded-2xl tw-p-6 tw-border-l-4 tw-border-green-500">
                <div className="tw-w-12 tw-h-12 tw-bg-green-500 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-text-white tw-font-bold tw-mb-4">1</div>
                <h3 className="tw-text-xl tw-font-bold tw-text-gray-900 tw-mb-3">Appoint Local Representative</h3>
                <p className="tw-text-gray-700">Ensure you have an official presence in Turkey responsible for your products through an authorized distributor, importer, or formal Authorized Representative.</p>
              </div>

              {/* Step 2 */}
              <div className="tw-bg-gradient-to-br tw-from-blue-50 tw-to-cyan-50 tw-rounded-2xl tw-p-6 tw-border-l-4 tw-border-blue-500">
                <div className="tw-w-12 tw-h-12 tw-bg-blue-500 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-text-white tw-font-bold tw-mb-4">2</div>
                <h3 className="tw-text-xl tw-font-bold tw-text-gray-900 tw-mb-3">Documentation Compliance</h3>
                <p className="tw-text-gray-700">Gather all required compliance documents and ensure they meet Turkish standards, including product certificates, test reports, and declarations of conformity.</p>
              </div>

              {/* Step 3 */}
              <div className="tw-bg-gradient-to-br tw-from-purple-50 tw-to-pink-50 tw-rounded-2xl tw-p-6 tw-border-l-4 tw-border-purple-500">
                <div className="tw-w-12 tw-h-12 tw-bg-purple-500 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-text-white tw-font-bold tw-mb-4">3</div>
                <h3 className="tw-text-xl tw-font-bold tw-text-gray-900 tw-mb-3">Update Labeling</h3>
                <p className="tw-text-gray-700">Review product labels, user manuals, and packaging to ensure they fulfill Turkish requirements with safety warnings in Turkish.</p>
              </div>

              {/* Step 4 */}
              <div className="tw-bg-gradient-to-br tw-from-orange-50 tw-to-amber-50 tw-rounded-2xl tw-p-6 tw-border-l-4 tw-border-orange-500">
                <div className="tw-w-12 tw-h-12 tw-bg-orange-500 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-text-white tw-font-bold tw-mb-4">4</div>
                <h3 className="tw-text-xl tw-font-bold tw-text-gray-900 tw-mb-3">Adapt E-Commerce Listings</h3>
                <p className="tw-text-gray-700">Work with e-commerce platforms to include all required information in online product listings before Turkish customers click &quot;buy.&quot;</p>
              </div>

              {/* Step 5 */}
              <div className="tw-bg-gradient-to-br tw-from-red-50 tw-to-pink-50 tw-rounded-2xl tw-p-6 tw-border-l-4 tw-border-red-500">
                <div className="tw-w-12 tw-h-12 tw-bg-red-500 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-text-white tw-font-bold tw-mb-4">5</div>
                <h3 className="tw-text-xl tw-font-bold tw-text-gray-900 tw-mb-3">Coordinate Logistics</h3>
                <p className="tw-text-gray-700">Choose supply chain partners wisely and engage with fulfillment centers in Turkey that are aware of the new rules.</p>
              </div>

              {/* Step 6 */}
              <div className="tw-bg-gradient-to-br tw-from-teal-50 tw-to-green-50 tw-rounded-2xl tw-p-6 tw-border-l-4 tw-border-teal-500">
                <div className="tw-w-12 tw-h-12 tw-bg-teal-500 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-text-white tw-font-bold tw-mb-4">6</div>
                <h3 className="tw-text-xl tw-font-bold tw-text-gray-900 tw-mb-3">Monitor & Respond</h3>
                <p className="tw-text-gray-700">Establish a system to continuously monitor regulatory updates and product feedback, with a rapid response plan for compliance issues.</p>
              </div>
            </div>
