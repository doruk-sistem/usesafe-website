  ...
  const integrationFeatures = [
    {
      ...
      description: "Quick setup with minimal disruption to your existing processes",
    },
    {
      icon: <FaCheckCircle className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Real-time Data Capture",
      description: "Automatically capture product data throughout the manufacturing process",
    },
    {
      icon: <FaCheckCircle className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Quality Assurance",
      description: "Maintain product quality standards with comprehensive tracking",
    },
  ];
  ...
  const features = [
    {
      ...
      description: "Track every step of your production process with detailed digital records and real-time monitoring.",
      delay: 0,
    },
    {
      icon: <FaUsers className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Supplier Management",
      description: "Manage your supplier network with comprehensive tracking and verification of all materials and components.",
      delay: 100,
    },
    {
      icon: <FaRecycle className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Sustainability Tracking",
      description: "Monitor and report on sustainability metrics throughout your supply chain and production process.",
      delay: 200,
    },
    {
      icon: <FaFileAlt className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Automated Documentation",
      description: "Generate comprehensive product documentation automatically with all required compliance information.",
      delay: 300,
    },
    {
      icon: <FaCogs className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Process Optimization",
      description: "Optimize your manufacturing processes with data-driven insights and performance analytics.",
      delay: 400,
    },
    {
      icon: <FaGlobe className="tw-w-6 tw-h-6 tw-text-primary" />,
      title: "Global Standards",
      description: "Meet international standards and regulations with built-in compliance frameworks and updates.",
      delay: 500,
    },
  ];
