...
export default function RegulatoryAuthoritiesGovernmentAgenciesPage() {
  ...
  const pageData = {
    ...
    heroDescription:
      "Access real-time compliance documentation and reporting. Streamline market surveillance and enforcement activities while aligning with digitalization goals and regulatory innovation.",
    heroImageSrc:
      "/images/platform/regulatory-authorities-government-agencies-hero.png",
    heroImageAlt: "Regulatory Authorities and Government Agencies",

    // Key Benefits Section
    benefitsTitle:
      "Why Regulatory Authorities & Government Agencies Choose UseSafe",
    benefitsDescription:
      "Digital product passports provide regulatory authorities and government agencies with real-time compliance monitoring, streamlined enforcement, and digital transformation capabilities.",
    keyBenefits: [
      {
    ...
    featuresDescription:
      "Everything you need to enhance compliance monitoring, streamline enforcement, and drive digital transformation in regulatory processes.",
    features: [
      {
    ...
    ctaDescription:
      "Join leading regulatory authorities and government agencies who trust UseSafe for their compliance monitoring needs. Start streamlining your enforcement activities and driving digital innovation today.",
