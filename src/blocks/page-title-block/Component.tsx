        ...
        <div className="row align-items-center justify-content-center small-screen">
          ...
          >
            {!!topTitle && (
              <div>
                <h1
                  className="text-uppercase mb-15px alt-font text-white opacity-6 fw-500 ls-2px"
            ...
            {!!title && (
              <h2
                className="m-auto text-white alt-font text-shadow-double-large fw-700 tw-w-full lg:tw-w-[500px]"
