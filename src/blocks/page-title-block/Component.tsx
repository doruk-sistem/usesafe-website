...
export function PageTitleBlock({
  ...
  return (
    <div
      className="page-title-big-typography tw-py-0 md:tw-py-22 ipad-top-space-margin tw-bg-black tw-bg-center tw-bg-cover" // py-10'u py-20 yaptım
    ...
    >
      ...
      <div className="container">
        <div className="row align-items-center justify-content-center small-screen">
          <div
            className="col-xl-8 col-lg-9 col-sm-10 position-relative text-center page-title-extra-small" // Genişliği artırdım
            data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 100, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'
          >
            {!!topTitle && (
              <div>
                <h1
                  className="text-uppercase mb-15px alt-font text-white opacity-6 fw-500 ls-2px tw-text-6xl md:tw-text-7xl" // Font boyutunu artırdım
            ...
            {!!title && (
              <h2
                className="m-auto text-white alt-font text-shadow-double-large fw-700 tw-w-full lg:tw-w-[800px] tw-text-4xl md:tw-text-5xl" // Genişlik ve font boyutunu artırdım
