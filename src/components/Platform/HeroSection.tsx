        ...
        {logos && logos.length > 0 && (
          <div className="tw-mt-16 tw-pt-12 tw-pb-0 tw-border-t tw-border-white/20">
            <div className="tw-relative tw-overflow-hidden tw-h-32 tw-w-full">
              <div className="tw-absolute tw-inset-0 tw-bg-gradient-to-r tw-from-transparent tw-via-transparent tw-to-transparent tw-z-10 tw-pointer-events-none"></div>
              ...
              >
                {logos.map((logo, index) => (
                  <SwiperSlide
                    ...
                    className="tw-w-auto"
                  >
                    <div className="tw-flex tw-items-center tw-justify-center tw-w-40 tw-h-20 tw-bg-transparent tw-rounded-2xl tw-border tw-border-white/20 hover:tw-scale-110 tw-transition-all tw-duration-300 tw-cursor-pointer">
                      <Image
                        src={logo.src}
                        alt={logo.alt}
                        width={160}
