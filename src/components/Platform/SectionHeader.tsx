...
const SectionHeader: React.FC<SectionHeaderProps> = ({
  ...
  return (
    <div className={`tw-max-w-3xl tw-mx-auto tw-mb-16 ${className}`}>
      <div className="tw-flex tw-justify-center tw-mb-6">
        <div className="tw-h-1 tw-w-24 tw-bg-primary tw-rounded-full"></div>
      </div>
      <h2
        className="tw-text-5xl tw-font-extrabold tw-text-gray-900 tw-drop-shadow-lg tw-mb-6 tw-text-center"
