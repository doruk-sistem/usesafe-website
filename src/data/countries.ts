...
export const countries: Country[] = [
  ...
  { value: "antigua_and_barbuda", label: "Antigua and Barbuda", code: "AG" },
  ...
  { value: "bosnia_and_herzegovina", label: "Bosnia and Herzegovina", code: "BA" },
  ...
  { value: "congo_brazzaville", label: "Congo (Brazzaville)", code: "CG" },
  { value: "congo_kinshasa", label: "Congo (Kinshasa)", code: "CD" },
  ...
  { value: "north_korea", label: "North Korea", code: "KP" },
  { value: "south_korea", label: "South Korea", code: "KR" },
  ...
  { value: "north_macedonia", label: "North Macedonia", code: "MK" },
  ...
  { value: "saint_kitts_and_nevis", label: "Saint Kitts and Nevis", code: "KN" },
  { value: "saint_lucia", label: "Saint Lucia", code: "LC" },
  { value: "saint_vincent_and_grenadines", label: "Saint Vincent and the Grenadines", code: "VC" },
  { value: "samoa", label: "Samoa", code: "WS" },
  { value: "san_marino", label: "San Marino", code: "SM" },
  { value: "sao_tome_and_principe", label: "Sao Tome and Principe", code: "ST" },
  ...
  { value: "timor_leste", label: "Timor-Leste", code: "TL" },
  { value: "togo", label: "Togo", code: "TG" },
  { value: "tonga", label: "Tonga", code: "TO" },
  { value: "trinidad_and_tobago", label: "Trinidad and Tobago", code: "TT" },
  ...
  { value: "united_arab_emirates", label: "United Arab Emirates", code: "AE" },
  ...
  { value: "vatican_city", label: "Vatican City", code: "VA" },
...
export const reasonsForReachingOut = [
